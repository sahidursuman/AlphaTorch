class EventsController < ApplicationController
  ...
  private
    ...
    def event_params
      params.require(:event).permit(:status_code, :workorder_id, :name, :cost, :start, :end, :all_day, event_services_attributes:[:id, :event_id, :service_id, :cost, :cost_dollars, :_destroy])
    end
end
